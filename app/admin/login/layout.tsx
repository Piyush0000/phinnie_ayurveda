  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-parchment via-cream to-turmeric-50">
      <div className="container-narrow flex min-h-screen flex-col items-center py-10">
        <Link href="/" aria-label="Thinnie Aurvadic" className="inline-flex items-center">
          <Image src="/logo.png" alt="Thinnie Aurvadic" width={200} height={89} priority className="h-14 w-auto" />
        </Link>
